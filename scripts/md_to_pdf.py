...
md_path = r"C:\Users\User\.hermes\workspace\memories\business\akoma\proposals\royal-zion-intl-school-integrated.md"
pdf_path = r"C:\Users\User\.hermes\workspace\memories\business\akoma\proposals\royal-zion-intl-school-integrated.pdf"
...
doc = SimpleDocTemplate(
    ...
    title="Royal Zion International School - Akoma Proposal",
...
while i < len(lines):
    ...
    if re.match(r'^-{3,}$', raw.strip()):
        if table_rows:
            ...
            if t: flow.append(t)
            table_rows = []
        flow.append(HRFlowable(width="100%", thickness=0.5, color=HexColor("#cccccc"), spaceBefore=4*mm, spaceAfter=4*mm))
        i += 1; continue
    ...
    if m:
        ...
        if level == 1:
            ...
            flow.append(HRFlowable(width="100%", thickness=1.2, color=HexColor("#0f3460"), spaceAfter=4*mm))
        else:
    ...
    if m:
        ...
        flow.append(Paragraph("• " + text, bullet_s))
        i += 1; continue
