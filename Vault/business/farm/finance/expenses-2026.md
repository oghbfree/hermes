---
title: Farm Expenses 2026
created: 2026-08-12
source: merged from FARM_WORKFLOW.md + legacy Vault/business/2real/Farming/farm/expenses.md
status: active
...
|------|------|-------|---------|--------------|
| 2026-06-01 | Glyphosate spray | Farmer Habib | Land spraying — Senya site | 500 |
| 2026-06-01 | Pepper seeds — Long Red | TBC | Pepper planting | 100 |
| 2026-06-01 | Pepper seeds — Scotch Bonnet | TBC | Pepper planting | 100 |
| 2026-06-08 | Kalidou arrival payment | Kalidou | Farm worker payment on arrival | 250 |
| 2026-06-18 | Kalidou second payment | Kalidou | Farm worker payment | 200 |
| 2026-06-? | Koko x2 (for Habib & Kalidou) | — | Food | — |
| 2026-06-? | New door padlock | — | Farm door security (~GHS 80) | 80 |
| 2026-06-? | Transplanted seedlings | Habib | Seedlings | 80 |
| | **June running total** | | | **~1,310+ GHS** |
...
| Date | Item | Payee | Purpose | Amount (GHS) |
|------|------|-------|---------|--------------|
| 2026-07-29 | Hive inspection, harvest & pressing (INV-000004) | Greensgold Agribusiness (Kwesi) | Apiary inspection of 3 field hives (invoiced as 4) + harvest + pressing | 800 |
| 2026-07-29 | Transportation (2-way) | Greensgold Agribusiness | Transport for Kwesi to/from farm | 100 |
| | **July running total** | | | **900 GHS** |
...
- Add receipts → WhatsApp photo → log here

---

*Migrated 2026-08-12. Source: legacy expenses.md + farmOS data + session history.*