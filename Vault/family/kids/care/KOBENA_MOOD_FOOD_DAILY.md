# KOBENA — MOOD & FOOD DAILY DIARY (Master Record)

> **Subject:** Kobena Herbert-Blankson (DOB 29/04/2014, ~12yo, ASD — see `KIDS_MASTER.md`, `care/KOBENA_CLINICAL_RECORD.md`)
> **Purpose:** Track daily food + mood/behaviour together. For Kobena these are linked, and this is the monitoring baseline for the facilitation plan, the natural/GFCF direction, and conversations with providers.
> **Format:** Consolidated master file (one per child) — do **NOT** create individual daily files.
> **Date format:** DMY as written; use **YYYY-MM-DD** in section headers.
> **Created:** 22/08/2026.

---

## How to log — concise markers (fill only what you know)

### Standard daily section
```markdown
### 2026-08-22 (Sat)
| Field | Notes |
|-------|-------|
...
| 🍽️ 🌙 Dinner | food |
| 🍎 Snacks | food |
| 💊 Supplements | pills/meds given |
| 💧 Drinks/water | rough amount |
| 😊 Mood (am) | — |
| 😊 Mood (pm) | — |
| 🧩 Behaviour / notable | e.g. calm, stimming, transition struggle, sensory moment |
| 😴 Sleep | e.g. asleep 22:00, woke 07:00 |
| 🚽 Bowel | e.g. normal/loose/constipated |
| 📝 Notes / change to routine | any food-intolerance reaction, new food tried |
```

### Mood & behaviour legend (keep simple)
- **Mood:** calm · happy · anxious · irritable · flat · distressed
- **Behaviour/regulation:** calm / stimming (which type) / sensory-seeking / sensory-overload / great transition / struggled with transition / good interaction / fought over toy
- **Sleep:** rough bedtime → wake time; if restless/awake overnight, note it

---

## The easiest way to feed me this
Just message it shorthand, like you do for H's diary — e.g.:
> **kobena 22/8/26** breakfast (plantain & eggs), lunch (rice & stew — blended veg), dinner (fish & potatoes). mood calm am, anxious pm. slept 21:30–06:30. bowel normal. gave NDF+VitD.

I'll append the matching `### 2026-08-XX` section under the current month.
...
<!-- New daily sections appended here, newest at bottom:

### 2026-08-23 (Sun)
| Field | Notes |
|-------|-------|
| 💊 06:30 | ½ tbsp **charcoal with water** (detox protocol — part of natural regimen) |
| 🍽️ ☀️ Breakfast (09:30) | Hausa koko |
| 🍽️ ☀️ ~11:00 | Green plantain ampesie |
| 🧩 Behaviour cues | Uses "hand-shaking + saying no" to refuse something he doesn't want |
| 🧩 Notable moments | Refused (said **no** ×2) when asked about food on a YouTube clip; closed laptop & put it away |
| 🧩 Echolalia/repetition | On being asked the time then to go check, spoke to himself in a **very high-pitched voice**, repeating phrases others have told him — incl. **"don't do that"** |
