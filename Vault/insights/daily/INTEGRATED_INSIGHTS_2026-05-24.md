...
| 09:08 | health-weekly-synthesis | ✅ OK | Duplicate run (same job, different ID) |
| 09:35 | dad-health-weekly-review | ✅ OK | Duplicate run |
...
| 3 | File permissions too perm644 on all credential files | MEDIUM | Unchanged 6+ days |
