...
When the user needs printable PDFs or social media graphics (not just HTML mockups), use Python libraries directly:
- **reportlab** for PDF generation (A4, letter, custom sizes)
- **Pillow** for social media graphics (1080×1080 Instagram, 1200×630 Facebook, etc.)

See `references/print-social-asset-generation.md` for code templates, font discovery, and common sizes.
